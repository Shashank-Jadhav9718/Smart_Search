...
from database import SessionLocal, Users, Documents, Logs
from auth import db_create_user, get_hashed_password
import os
import shutil
        ...
        with st.form("add_user_form", clear_on_submit=True):
            ...
            if submitted:
                if not new_username or not new_password:
                    ...
                    success = db_create_user(new_username, new_password, new_role)
                    if success:
